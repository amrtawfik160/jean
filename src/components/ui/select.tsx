  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'rounded-lg border border-border bg-surface-1 px-3 text-sm',
        'data-[size=default]:h-8 data-[size=sm]:h-7',
        'transition-[color,box-shadow,border-color,background-color] duration-150 outline-none',
        ...
        'focus-visible:border-primary/70 focus-visible:ring-2 focus-visible:ring-primary/35',
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'rounded-lg',
          'relative z-[80] max-h-(--radix-select-content-available-height) min-w-[10rem]',
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-pointer items-center gap-2 rounded-md py-1.5 pr-8 pl-2 mx-1 my-0.5 text-sm outline-hidden select-none',
